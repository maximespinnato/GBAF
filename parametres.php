...
// Modification du nom
if (!empty($_POST['nom']) && strlen($_POST['nom']) <= MAX_LOGIN)
{
...
if (!empty($_POST['prenom']) && strlen($_POST['prenom']) <= MAX_LOGIN)
{
...
if (!empty($_POST['question']) && strlen($_POST['question']) <= MAX_PHRASES)
{
...
if (!empty($_POST['reponse']) && strlen($_POST['reponse']) <= MAX_PHRASES)
{
...
echo '<fieldset>';
echo '<p><label>Nom : <br/>
			<input type="text" name="nom" placeholder="' . htmlspecialchars($donnees['lastname']) . '" maxlength="' . MAX_LOGIN . '"/>
		 </label></p>';
echo '<p><label>Prénom : <br/>
			<input type="text" name="prenom" placeholder="' . htmlspecialchars($donnees['firstname']) . '" maxlength="' . MAX_LOGIN . '"/>
		 </label></p>';	
echo '<p><label>Identifiant : <br/>
			<input type="text" name="pseudo" placeholder="' . htmlspecialchars($donnees['login']) . '" maxlength="' . MAX_LOGIN . '"/>
		 </label></p>';		
echo '<p><label>Question secrète : <br/>
			<input type="text" name="question" placeholder="' . htmlspecialchars($donnees['question']) . '" maxlength="' . MAX_PHRASES . '"/>
		 </label></p>';
