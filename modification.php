...
if (!empty($_POST['motdepasseActuel']) && strlen($_POST['motdepasseActuel']) <= MAX_LOGIN 
	|| !empty($_POST['reponseActuelle']) && strlen($_POST['reponseActuelle']) <= MAX_PHRASES)
{
